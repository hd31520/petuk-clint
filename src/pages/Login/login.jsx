...
const Login = () => {
    const { signInUser, signInWithGoogle, signInWithGitHub, loading } = useContext(AuthContext);
            ...
            <div className="hero-content flex-col lg:flex-row-reverse w-full max-w-4xl">
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl lg:w-1/2">
                    <div className="card-body">
                        ...
                        <div className="form-control mt-4">
                            <button onClick={handleGitHubSignIn} disabled={loading} className="btn bg-black text-white border-black">
